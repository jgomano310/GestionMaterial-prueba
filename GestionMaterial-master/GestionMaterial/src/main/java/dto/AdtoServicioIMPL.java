...
public class AdtoServicioIMPL implements AdtoServicio {
	...
	@Override
	public PortatilDTO PortatilaDTO(Calendar md_date, String marca, String modelo, Alumno alumno) {
		PortatilDTO portatilDTO = new PortatilDTO( md_date,  marca,  modelo, alumno);
